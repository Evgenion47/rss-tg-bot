#protoc --go_out=pkg --go_opt=paths=source_relative --go-grpc_out=pkg --go-grpc_opt=paths=source_relative --grpc-gateway_out=pkg --grpc-gateway_opt=paths=source_relative generate_unbound_methods=true --openapiv2_out . api/api.proto
